    ...
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        <div className={styles.body}>
          ...
          <h3>8. Contact</h3>
          <p>For any questions regarding these terms, please contact us at <strong>outreach@roboleague.edu</strong>. We are committed to ensuring your experience is safe, educational, and fun.</p>
        </div>
